...
def test_SKZCAMInputSet_create_element_info(skzcam_clusters_output):
    ...
    with pytest.raises(
        ValueError,
        match="basis must be provided as a string or dictionary of elements.",
    ):
        element_info = skzcam_input_set.create_element_info(
            basis=[2, 2, 10],
            frozencore="semicore",
...
def test_SKZCAMInputSet_generate_input(skzcam_clusters_output, tmp_path):
    ...
    assert tmp_path_files == [
        ...
        "MRCC_MINP_MP2_cluster_1_def2-SVP_adsorbate",
        "MRCC_MINP_MP2_cluster_1_def2-SVP_adsorbate_slab",
        "MRCC_MINP_MP2_cluster_1_def2-SVP_slab",
        "MRCC_MINP_MP2_cluster_2_awCVDZ_adsorbate",
        "MRCC_MINP_MP2_cluster_2_awCVDZ_adsorbate_slab",
        "MRCC_MINP_MP2_cluster_2_awCVDZ_slab",
        "MRCC_MINP_MP2_cluster_2_def2-SVP_adsorbate",
        "MRCC_MINP_MP2_cluster_2_def2-SVP_adsorbate_slab",
        "MRCC_MINP_MP2_cluster_2_def2-SVP_slab",
    ...
    assert mrcc_adsorbate_slab_lines == [
        "calc=LNO-CCSD(T)\n",
        "no-basis-set\n",
        "no-basis-set\n",
        "aug-cc-pVDZ-RI\n",
    ...
    skzcam_input_set = SKZCAMInputSet(
        ...
        mp2_oniom1_hl={
            ...
            "frozencore": "valence",
            "basis": {
                "C": "CBS(def2-SVP/def2-TZVPP)",
                "O": "CBS(def2-SVP/def2-TZVPP)",
                "Mg": "CBS(def2-TZVPP/def2-QZVPP)",
            },
            "code": "orca",
        },
    )
    ...
    tmp_path_files.sort()
    assert tmp_path_files == [
        "MRCC_MINP_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_adsorbate",
        "MRCC_MINP_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_adsorbate_slab",
        "MRCC_MINP_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_slab",
        "MRCC_MINP_MP2_cluster_2_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_adsorbate",
        "MRCC_MINP_MP2_cluster_2_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_adsorbate_slab",
        "MRCC_MINP_MP2_cluster_2_C-def2-SVP_Mg-def2-TZVP_O-def2-TZVPP_slab",
        "ORCA_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVPP_O-def2-SVP.pc",
        "ORCA_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVPP_O-def2-SVP_adsorbate.inp",
        "ORCA_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVPP_O-def2-SVP_adsorbate_slab.inp",
        "ORCA_MP2_cluster_1_C-def2-SVP_Mg-def2-TZVPP_O-def2-SVP_slab.inp",
        "ORCA_MP2_cluster_1_C-def2-TZVPP_Mg-def2-QZVPP_O-def2-TZVPP.pc",
        "ORCA_MP2_cluster_1_C-def2-TZVPP_Mg-def2-QZVPP_O-def2-TZVPP_adsorbate.inp",
        "ORCA_MP2_cluster_1_C-def2-TZVPP_Mg-def2-QZVPP_O-def2-TZVPP_adsorbate_slab.inp",
        "ORCA_MP2_cluster_1_C-def2-TZVPP_Mg-def2-QZVPP_O-def2-TZVPP_slab.inp",
    ]
    ...
    with pytest.raises(
        ValueError, match="basis must be given as a string or a dictionary."
    ):
        skzcam_input_set = SKZCAMInputSet(
            adsorbate_slab_embedded_cluster=skzcam_clusters_output[
                "adsorbate_slab_embedded_cluster"
